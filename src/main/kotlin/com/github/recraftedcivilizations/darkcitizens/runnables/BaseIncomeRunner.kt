...
class BaseIncomeRunner(val jobManager: JobManager, private val playerManager: DPlayerManager, private val economy: Economy, private val bukkitWrapper: BukkitWrapper = BukkitWrapper()) :
    BukkitRunnable() {
    override fun run() {
