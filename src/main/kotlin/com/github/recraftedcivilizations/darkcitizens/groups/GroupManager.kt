...
class GroupManager {
     ...
     */
    fun createGroup(name: String, maxLvl: Int, lvlThresholds: List<Int>, friendlyFire: Boolean, canBeCriminal: Boolean, prefix: String){
        ...
        val newGroup = Group(name, maxLvl, fixedThresholds, friendlyFire, canBeCriminal, prefix)
